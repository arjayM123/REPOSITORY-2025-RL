...
$allowed_pages = ['dashboard', 'add_books', 'manage-books', 'reports', 'list_books','edit_book'];
        ...
        <div class="position-fixed bg-dark min-vh-100" style="width: 280px; left: 0; top: 0;">
            <div class="d-flex flex-column h-100">
                ...
                <div class="text-center py-4 border-bottom border-secondary">
                    <img src="../assets/images/images-removebg-preview.png" alt="Logo" class="img-fluid mb-2"
                ...
                <nav class="nav flex-column py-3 flex-grow-1">
                    <!-- Dashboard -->
                    <a class="nav-link text-white py-3 px-4 d-flex align-items-center <?php echo ($page == 'dashboard') ? 'bg-primary' : ''; ?>"
                        href="?page=dashboard" data-bs-toggle="tooltip" data-bs-placement="right" title="Dashboard">
                    ...
                    <div class="nav-item">
                        <a class="nav-link text-white py-3 px-4 d-flex align-items-center" data-bs-toggle="collapse"
                            href="#catalogingMenu" role="button" aria-expanded="false" aria-controls="catalogingMenu">
                        ...
                        <div class="collapse" id="catalogingMenu">
                            <div class="bg-secondary bg-opacity-25">
                                <a class="nav-link text-white-50 py-2 px-5 d-flex align-items-center"
                                    href="?page=add_books">
                                    <i class="bi bi-plus-circle me-3"></i>
                                    <span>Create New Book</span>
                                </a>
                                <a class="nav-link text-white-50 py-2 px-5 d-flex align-items-center"
                                    href="?page=manage-books">
                    ...
                    <!-- Reports -->
                    <a class="nav-link text-white py-3 px-4 d-flex align-items-center <?php echo ($page == 'reports') ? 'bg-primary' : ''; ?>"
                        href="?page=reports" data-bs-toggle="tooltip" data-bs-placement="right" title="Reports">
                        <i class="bi bi-graph-up me-3"></i>
                        <span>Reports</span>
                    </a>

                    <!-- Book List -->
                    <a class="nav-link text-white py-3 px-4 d-flex align-items-center "href="list_books.php">
                ...
                <div class="mt-auto border-top border-secondary">
                    <a class="nav-link text-danger py-3 px-4 d-flex align-items-center" 
                       href="logout.php" 
